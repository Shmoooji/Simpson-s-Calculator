  ...
  div(class = "container py-4", style = "max-width:940px;",
    ...
    card(class = "mt-3",
      ...
      card_body(
        ...
        p(HTML("Another important realization from developing this project was how
       numerical methods bridge the gap between pure mathematics and practical
       computation. While definite integrals are often solved analytically in
       calculus classes, many real-world functions either have no elementary
       antiderivative or are too complex to integrate by hand. Implementing
       Simpson's 1/3 Rule in R demonstrated how numerical approximation allows
       us to still obtain highly accurate solutions efficiently. It also showed
       us the importance of visualization — seeing the parabolic fits directly
       on the graph made the geometric intuition behind the method much easier
       to understand.")),
        p(HTML("This Calculator is made to solve Simpson's while being able to learn step by step. So give it a go :)")),
        
        div(class = "callout success",
          HTML("<strong>Bottom line:</strong> Simpson's 1/3 Rule is a practical,
                accurate, and widely applicable tool. When the integrand is smoot
